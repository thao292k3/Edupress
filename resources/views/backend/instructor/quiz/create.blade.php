            ...
            <form action="{{ route('instructor.quizzes.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="pass_score" class="form-control @error('pass_score') is-invalid @enderror" 
                               min="0" max="100" value="{{ old('pass_score', 60) }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="duration_minutes" class="form-control @error('duration_minutes') is-invalid @enderror" 
                               min="1" value="{{ old('duration_minutes') }}" placeholder="Để trống nếu không giới hạn">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                            ...
                            <option value="1" {{ old('status') == 1 ? 'selected' : '' }}>1 - Active (Hoạt động)</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="show_result_immediately" value="1" id="showResultCheck" {{ old('show_result_immediately') ? 'checked' : '' }}>
                ...
                <button type="submit" class="btn btn-success mt-3"><i class="fas fa-plus"></i> Tạo Quiz và Thêm Câu hỏi</button>
            </form>
